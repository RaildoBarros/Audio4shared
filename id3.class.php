   ...
   **************/
   ...
   function getGenre(){
      if (array_key_exists('TCON',$this->tags)){
		$start = strrpos($this->tags['TCON'],'(');
		#echo 'Start: '.$start.'<br/>';
		$length = strrpos($this->tags['TCON'],')') - $start;
		$number = substr($this->tags['TCON'],$start+1,$length-1);
		#echo 'Number: '.$number.'<br/>';
		#echo 'Genre: '.$this->id3_genres_array[$number].'<br/>';
		return $this->id3_genres_array[$number];
